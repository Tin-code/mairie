    ...
    <div class="container-fluid">
        <div class="row p-4">
            ...
            <div class="col-12 col-md-8 mt-3 text-center">
                ...
                <div class="mt-5">
                    <div class="m-2">
                        <a class="m-2 btn btn-success" href="naissance.php">Estrait rapide</a>
                        <a class="m-2 btn btn-success" href="mariage.php">Mariage</a>
                        <a class="m-2 btn btn-success" href="certificats.php">Certificats</a>
                        <a class="m-2 btn btn-success" href="autorisations.php">Autorisations</a>
                    </div>
                    <div class="m-2">
                        <a class="m-2 btn btn-success" href="naissance.php">Naissance</a>
                        <a class="m-2 btn btn-success" href="deces.php">Acte de décès</a>
                        <a class="m-2 btn btn-success" href="legalisation.php">Légalisation</a>
                        <a class="m-2 btn btn-success" href="divers.php">Autres</a>
                    </div>
                </div>
            </div>
            <div class="row mt-5">
